<template>
    <header class="app-header" :style="headerBackground" :class="{ isDark: isDark }">
        ...
        <section class="user-buttons flex row align-center gap">
            ...
            <svg xmlns:xlink="http://www.w3.org/1999/xlink" width="24" height="24" role="presentation" focusable="false"
            ...
            <div @click="(showUserPreview = !showUserPreview)">
                <div v-if="user.imgUrl" class="member-image" :style="memberImage(user.imgUrl)"> </div>
