...
export default {
    ...
    methods: {
        ...
        getPhotos() {
            ...
            let apiUrl = `https://api.unsplash.com/search/photos?query=${this.searchTxt ? this.searchTxt : 'landscape'}&orientation=landscape&per_page=1200&client_id=${this.clientId}`
